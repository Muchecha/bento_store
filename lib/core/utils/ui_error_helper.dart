    ...
    final result = await showDialog<bool>(
      ...
      builder:
          (context) => AlertDialog(
            ...
            content: Text(message),
            actions: [
              TextButton(onPressed: () => Navigator.of(context).pop(false), child: Text(cancelButtonText)),
              ElevatedButton(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(message, style: TextStyle(color: AppTheme.errorColor), textAlign: TextAlign.center),
            const SizedBox(height: 16),
            ElevatedButton(
              onPressed: onRetry,
              style: ElevatedButton.styleFrom(backgroundColor: AppTheme.primaryColor),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(message, style: TextStyle(color: Colors.grey[700]), textAlign: TextAlign.center),
            const SizedBox(height: 20),
            ElevatedButton.icon(
              onPressed: onRetry,
